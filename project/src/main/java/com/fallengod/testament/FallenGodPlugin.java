...
import com.fallengod.testament.listeners.DatapackAltarListener;
 ...
 * Now integrated with datapack-based altar generation
 */
public class FallenGodPlugin extends JavaPlugin {
    ...
    public void onEnable() {
        try {
            ...
            getLogger().info("Datapack integration enabled - Altars will generate naturally!");
    ...
    private void registerEventListeners() {
        ...
        getServer().getPluginManager().registerEvents(
            new DatapackAltarListener(this), this);
