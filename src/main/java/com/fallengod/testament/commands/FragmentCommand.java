...
/**
 * Command handler for fragment management
 * Updated to remove altar generation commands (now handled by datapack)
 */
public class FragmentCommand implements CommandExecutor, TabCompleter {
    ...
    private void sendHelp(CommandSender sender) {
        ...
        sender.sendMessage("§7Use /datapack commands for altar management!");
    }
    ...
    public List<String> onTabComplete(CommandSender sender, Command command, String alias, String[] args) {
        ...
        switch (args.length) {
            case 1:
                completions.addAll(Arrays.asList("spawn", "heart", "veil", "stats", "clear", "giveall", "progress", "help"));
                break;
            case 2:
                if (args[0].equalsIgnoreCase("spawn") || args[0].equalsIgnoreCase("giveall")) {
